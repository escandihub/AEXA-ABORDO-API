...
<div class="fixed inset-0  top-0 left-0 z-50 mx-auto w-screen h-screen flex items-center justify-center" style="background: rgba(0, 0, 0, 0.3);">
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <div class="p-4 md:p-5 space-y-4 flex flex-col gap-2 mx-auto">
                <form>
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        <div>
                            ...
                            <input type="text" id="first_name" 
                                ...
                                placeholder="{{ $usuario->user }}" required />
                        </div>
                        <div>
                            <label for="first_name"
                            ...
                            <input type="text" id="first_name" 
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="{{ $usuario->pass }}" required />
                        </div>
                ...
                <div class="flex items-center">
                    ...
                    {{-- {{ $usario->isActive ? 'Activado' : 'Desactivado' }} --}}
                </div>
            </div>
            <!-- Modal footer -->
