                ...
                <form wire:submit="generateLink" class="max-w-2xl mx-auto space-y-6">
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <ul class="select-none grid w-full gap-4 md:grid-cols-3" x-data="{ selectOption: ''}">
                                <li>
                                    <input type="radio" id="react-option" value="react-option" name="technologies"
                                        class="hidden peer" required="" wire:model="selectOption">
                                    <label for="react-option"
                                        ...
                                        <div class="block">
                                            <svg class="mb-2 w-7 h-7 text-sky-600" fill="currentColor"
                                ...
                                <li>
                                    <input type="radio" id="aexa-op" value="aexa" name="technologies"
                                        class="hidden peer" wire:model="selectOption">
                                    <label for="aexa-op" x-click="selectOption = aexa"
                                        x-transition:enter="transition ease-out duration-300"
                                        x-transition:enter-start="opacity-0 scale-90"
                                        :class="selectOption == 'aexa' ? 'bg-blue-400 rounded-md' : ''"
                                        class="inline-flex items-center justify-between w-full p-5 text-body bg-neutral-primary-soft border-1 border-default rounded-base cursor-pointer peer-checked:hover:bg-brand-softer peer-checked:border-brand-subtle peer-checked:bg-brand-softer hover:bg-neutral-secondary-medium peer-checked:text-fg-brand-strong">
                                        <div class="block">
                                            <svg class="mb-2 text-success w-7 h-7" fill="currentColor"
                                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 448 512">
                                                <path
                                            ...
                                            <div class="w-full text-sm">An model–view front end JavaScript framework.
                                            </div>
                                        </div>
                                    </label>
                                </li>
                                <li>
                                    <input type="radio" id="angular-option" value="angular-option" name="technologies"
                                        class="hidden peer" wire:model="selectOption">
                                    <label for="angular-option"
                                        class="inline-flex items-center justify-between w-full p-5 text-body bg-neutral-primary-soft border-1 border-default rounded-base cursor-pointer peer-checked:hover:bg-brand-softer peer-checked:border-brand-subtle peer-checked:bg-brand-softer hover:bg-neutral-secondary-medium peer-checked:text-fg-brand-strong">
                                        <div class="block">
                                            <svg class="mb-2 text-danger w-7 h-7" fill="currentColor" aria-hidden="true"
