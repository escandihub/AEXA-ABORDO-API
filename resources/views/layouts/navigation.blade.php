        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('terminales')" :active="request()->routeIs('terminales')" wire:navigate >
                        {{ __('Terminales') }}
                    </x-nav-link>
                    <x-nav-link :href="route('app.abordo.traking')" :active="request()->routeIs('app.abordo.traking')" wire:navigate >
                        {{ __('versiones app') }}
                    </x-nav-link>
                    {{-- <x-nav-link :href="route('device.access')" :active="request()->routeIs('device.access')" wire:navigate >
                        {{ __('Lista de acceso') }}
                    </x-nav-link> --}}
